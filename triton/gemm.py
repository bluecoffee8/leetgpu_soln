...
def matrix_multiplication_kernel(
    a, b, c, M, N, K, alpha, beta, stride_am, stride_an, stride_bn, stride_bk, stride_cm, stride_ck,
    ...
    c_init = tl.load(c_block, mask=c_mask, other=0.0)
    c_val = beta * c_init + alpha * c_val
